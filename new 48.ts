How Can I connect my html table in the siteComponent communicate with the AddEditSiteComponent so that when the edit link is clicked, the form is able to be populated by 
the data got from the table and the data can be changed or updated and when the delete link is clicked, the form is deleted
